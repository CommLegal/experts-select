...
$confirmedMRO = $conn->execute_sql("select", array("*"), "organisation_agreements JOIN m_accounts ON oa_ma_name = ma_id AND oa_confirmed = 5", "oa_ea_name=?", array("i1" => $_SESSION['CME_USER']['login_id']));
	...
	<?php 
        foreach($confirmedMRO as $header => $value) { 
          ...
          <tr>
                ...
                <td class="tg-031e">
                    <?php echo $confirmedMRO[$header]['oa_blocked_note']; ?>
                </td>
                <td class="tg-031e">
                    ...
                    <a href = "#" id = "enable-expert:<?php echo $confirmedMRO[$header]['oa_id']; ?>" class = "show-overlay btn btn-default btn-sm" title="Enable MRO"><i class="fa fa-lg fa-user-plus"></i></a>
                    <a href = "#" id = "block-expert:<?php echo $confirmedMRO[$header]['oa_id']; ?>" class = "show-overlay btn btn-default btn-sm" title="Block MRO"><i class="fa fa-lg fa-ban"></i></a>
