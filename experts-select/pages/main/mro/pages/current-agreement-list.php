...
$confirmedExpert = $conn->execute_sql("select", array("*"), "organisation_agreements JOIN e_accounts ON oa_ea_name = ea_id AND oa_mo_name = '".$getCompanyNo[0]['ma_name']."' AND oa_confirmed = 1", "", "");
	...
	foreach($confirmedExpert as $header => $value) { ?>
      <tr>
        ...
        <td class="tg-031e">
            ...
            <!--<a href = "#" class = "btn btn-default btn-sm" title="View Agreement"><i class="fa fa-lg fa-file-text-o"></i></a>
            <a href = "#" class = "btn btn-default btn-sm" title="Edit"><i class="fa fa-lg fa-pencil"></i></a>
            <a href = "#" class = "btn btn-default btn-sm" title="Cancel"><i class="fa fa-lg fa-times"></i></a>
            <a href = "#" class = "btn btn-default btn-sm" title="Block"><i class="fa fa-lg fa-ban"></i></a>-->
            
            <a href = "#" id = "view-agreement:<?php echo $confirmedExpert[$header]['oa_id']; ?>" class = "show-overlay  btn btn-default btn-sm" title="View/Edit Agreement"><i class="fa fa-lg fa-pencil"></i></a>
            <a href = "#" id = "cancel-agreement:<?php echo $confirmedExpert[$header]['oa_id']; ?>" class = "show-overlay btn btn-default btn-sm" title="Cancel Agreement"><i class="fa fa-lg fa-times"></i></a>
