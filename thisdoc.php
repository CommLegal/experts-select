<div id="overlay" style = "left:0%; margin-top:80px"  > <!-- USED TO CHANGE MODAL ON ADD_APPOINTMENTS!!! -->
    <div id="overlay-content">
        <div id="close" style = "background-color:#5CB85C"><button type="button" class="close" ><p>Close ×</p></button></div>
...
<?php 
		...
		$appArray = $conn->execute_sql("select", array("eap_id", "eap_date"), "e_appointments", "eap_date >= ? AND eap_date <= ? AND eap_ea_id =? order by eap_date", array("s1" => $newDate . " 00:00:00", "s2" => $newDate . " 23:59:59", "i" => $_SESSION['CME_USER']['login_id']));
