...
$selectOption = $conn->execute_sql("select", array("v_name", "v_id", "v_ea_id", "v_city", "v_postcode" ), "venues group by v_name ", "", "");
...
echo '<option>' . '' . "Select Existing Venue To Add" . '' . '</option>';
//END
...
{	
	...
	echo  "<option id=\"venueTest\" name=\"" . $selectOption[$header]['v_id'] . "\">" . $selectOption[$header]['v_name'] . /*" - " . $selectOption[$header]['v_city'] .*/ " - " . $selectOption[$header]['v_postcode'] . "</option>";
