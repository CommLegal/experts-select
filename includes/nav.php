					...
					<li>
					  <div class="dropdown" style="margin-right:10px;">
						...
						<ul class="dropdown-menu">
						  <li><a href="../pages/reg/registration-mro.php">MRO <abbr title="Select if you represent an MRO" class="fat">(?)</abbr></a></li>
						  <li><a href="../pages/reg/registration-expert.php">Expert <abbr title="Select if you're a health expert" class="fat">(?)</abbr></a></li>
						</ul>
					  </div>
					</li>
					<li>
