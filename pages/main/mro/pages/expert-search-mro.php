                        ...
                        <div class="row pt25">
                            ...
                            <h1>Expert finder</h1>
                                <div class="panel panel-default">
                                  <div class="panel-heading"><h4>Find Experts</h4></div>
                                  <div class="panel-body">
                                  
								<div class="col-lg-6"><!-- /input-group -->
                                     <p>Search for experts here. You can search their names, postcodes, towns and areas. Specify a distance radius to show
                                     all surrounding experts within that given value (needs changing).
                                     </p>
								<div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search for medical experts~">
                                    <span class="input-group-btn"><button class="btn btn-default" type="button"><i class="fa fa-search"></i></button></span>
								</div></div>
                                     
                                     <div class="col-lg-6">
                                     <p><i class="fa fa-star"></i> Save the expert to your list.</p>
                                     <p><i class="fa fa-eye"></i> View similar and nearby experts.</p>
							...
							<!-- BOTTOM BOX -->
							<div class="row pt25"><div class="col-md-4 bg-grey topradius pq"><h4 class ="midd">Results</h4></div></div>
							<!-- Appointments list -->
							<div class="row">
