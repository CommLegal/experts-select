	...
	<div class="container mb25 bg-blue quickborder">
				...
				<div class="col-md-10 green diarypadding">
                        <div class="row pt25">
							...
							<div class="col-lg-12">
                                <div class="panel panel-default allradius">
                                  <div class="panel-heading"><h4>User Manager</h4></div>
                                  <div class="panel-body">
                                  
                                 	<div class="col-lg-6">
										<h3>Creating users</h3>
                                        <p>Add users by filling out the form. Click 'create' to add them to the table below.</p>
                                        <p><i class="fa fa-pencil"></i> Edit user account settings and privileges.<br>
                                        <i class="fa fa-user-times"></i> Delete the user account from the list.</p><br>
                                        
                                        <h3>User types</h3>
                                        <p>User: Manage bookings, do this, edit that etc.</p>
                                        <p>Manager: Manage bookings, do more of this, edit more of that etc.</p>
                                        <p>Administrator: Owns the account, has full access and privilege to everything etc.</p>
                                 	</div>
                                 	 ...
                                 	 <div class="col-lg-6">
                                        ...
                                        <div class="form-group col-lg-12">
                                          <label class="control-label">Username</label>
                                            <input type="email" name="email" class="form-control" id="username" value="" placeholder="" required>
                                        </div>

                                        <div class="form-group col-lg-6">
                                          <label class="control-label">Password</label>
                                            <input type="email" name="email" class="form-control" id="pass1" value="" placeholder="" required>
                                        </div>

                                        <div class="form-group col-lg-6">
                                          <label class="control-label">Confirm Password</label>
                                            <input type="email" name="email" class="form-control" id="pass2" value="" placeholder="" required>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12">
                                          <label class="control-label">Active </label>
                                            <input type="checkbox" name="active" value="activebox" required>
                                        </div>

                                     <a class="btn btn-primary pull-right" href="#">Create</a>
                                 </div>
                    ...
                    <!-- tab box top -->
						<div class="col-md-12 green diarypadding">
                            <ul class="row nav nav-tabs">
                              <li class="active"><a class = "topradius noleftborder" href="#tab_a" data-toggle="tab"><h4 class ="midd">Users</h4></a></li>
                            </ul>
                    <!-- tab box top close-->       
					<div class="row tab-content bg-grey bottomradius toprightradius pb25 mb25" style="margin-top:-30px; padding:15px;">
                            
                            <!-- tab A --><div class="tab-pane active" id="tab_a">

									<style type="text/css">
										.tg  {border-collapse:collapse;border-spacing:0;border-color:#ccc;margin:0px auto;}
										.tg td{font-family:Arial, sans-serif;font-size:14px;padding:10px 10px;
										border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#ccc;
										color:#333;background-color:#fff;}
										.tg th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 20px;
										border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#ccc;
										...
										<!-- Could possibly have colour coded appointments,  -->
										  <tr><!-- Top row -->
											<th class="tg-031e midd"><h4>Username</h4></th>
											<th class="tg-031e midd"><h4>Email</h4></th>
											<th class="tg-031e midd"><h4>Access</h4></th>
											<th class="tg-031e midd"><h4>Actions</h4></th>
										  </tr>

										  <tr><!-- Content -->
											<td class="tg-031e"><a href="#">Elliot Rushforth</a></td>
											<td class="tg-031e">elliot.rushforth@onecalldirect.co.uk</td>
											<td class="tg-031e">User</td>
											<td class="tg-031e">
                                               <abbr title="Edit User"><i class="fa fa-pencil"></i></a></abbr>
                                               <abbr title="Remove User"><i class="fa fa-user-times"></i></a></abbr>
                                               <!-- <abbr title="Edit"><i class="fa fa-pencil"></i></a></abbr> -->
                                            </td>
										  </tr>
                                          
										  <tr><!-- Content -->
											<td class="tg-031e"><a href="#">Jonathan Sutton</a></td>
											<td class="tg-031e">jonathan.sutton@onecalldirect.co.uk</td>
											<td class="tg-031e">Administrator</td>
											<td class="tg-031e">
                                               <abbr title="Edit User"><i class="fa fa-pencil"></i></a></abbr>
                                               <abbr title="Remove User"><i class="fa fa-user-times"></i></a></abbr>
                                               <!-- <abbr title="Edit"><i class="fa fa-pencil"></i></a></abbr> -->
                            ...
                            <!--tab a close--></div>
                            <!-- tab B --><div class="tab-pane" id="tab_b">
