...
<!-- Content -->
    <div class= "container main">
        <form id="submit-mro-message-form">
            <div class="col-md-12">              
            ...
            <div class = "col-md-3 ">
                ...
                <select name="expert_id" id="expert_id" class="venue-box" style="width:250px; height:35px;">
                  <option id="ea_options" name="ea_options" value="1" onclick="loadList">Recipient</option>
           		</select>
            </div>
            ...
            <div class = "col-md-12">
                <button id = "submit-mro-message" class = "<?php echo $btncolor ?> btn-lg mt25 mb25">Send &nbsp;<i class = "fa fa-envelope"></i></button>
            </div> 
