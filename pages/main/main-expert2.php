...
<body>
	...
	<div class="container mb25">
				<div class="bg-blue bgtrans nop col-md-2"><!-- Big nest -->
					...
					<!-- Content -->	
						...
						<div class="col-md-10 green diarypadding">
                            ...
                            <ul class="row nav nav-tabs">
                              <li class="active"><a class = "topradius noleftborder" href="#tab_a" data-toggle="tab"><h4 class ="midd">Updates <span class="badge">3</span></h4></a></li>
                              <li><a class="topradius" href="#tab_b" data-toggle="tab"><h4 class ="midd">Reminders</h4></a></li>
                            </ul>
                            <div class="row tab-content bg-grey bottomradius" style="margin-top:-30px; padding:15px;">
                            
                            <div class="tab-pane active" id="tab_a">
                                <div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert">&times;</button>
                                <h4><i class="fa fa-exclamation-circle"></i> 1 unchecked item.</h4><br>
                                An item needs your attention, <a href="#">click here </a>to expand.</div>
							...
							<!-- BOTTOM BOX -->
							<div class="row pt25"><div class="col-md-4 bg-grey topradius pq"><h4 class ="midd">Appointments</h4></div></div>
							<!-- Appointments list -->
							<div class="row">
