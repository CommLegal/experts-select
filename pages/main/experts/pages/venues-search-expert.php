                        ...
                        <div class="row pt25">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-6"><!-- /input-group -->
                                     <p>Search for venues here. You can search venue names, postcodes, towns and areas. Specify a distance radius to show
                                     all surrounding venues within that given value (needs changing).
                                     </p>
								<div class="input-group">
                                    ...
                                    <span class="input-group-btn"><button class="btn btn-default" type="button"><i class="fa fa-search"></i></button></span>
                                     ...
                                     <div class="col-lg-6">
                                     <p><i class="fa fa-star"></i> Save a venue to your list.</p>
                                     <p><i class="fa fa-eye"></i> View similar and nearby venues.</p>
                    ...
                    <!-- tab box top -->
						<div class="col-md-12 green diarypadding">
                            <ul class="row nav nav-tabs">
                              <li class="active"><a class = "topradius noleftborder" href="#tab_a" data-toggle="tab"><h4 class ="midd">Search Results</h4></a></li>
									...
									<style type="text/css">
										...
										<!-- Could possibly have colour coded appointments,  -->
										  ...
										  <tr><!-- Content -->
											...
											<td class="tg-031e">
                                               <abbr title="Save"><i class="fa fa-star"></i></a></abbr>
