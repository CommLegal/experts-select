<div class="row col-md-12">
	<div class="glyphicon glyphicon-refresh"></div><a href="#" id="hide-expert-apps">&nbsp;Hide Taken Appointments</a><a href="#" id="show-expert-apps">&nbsp;Show Taken Appointments</a></div>
	</br></br>
</div>
<!-- Appointments list -->
<div class="row">
