...
<div class="col-lg-12"> 
                                <div class="panel panel-default">
                                 ...
                                 <div class="col-lg-6">
                                     <p>Here you can edit your list of saved venues. Click the name for further
                                     details including a map and their website, if possible.</p></div>
								<div class="col-lg-6">
                                              <i class="fa fa-thumbs-o-up"></i> Add to your list of saved favorites.<br>
                                              <i class="fa fa-eye"></i> Find other similar venues near this one.<br>
                                              <i class="fa fa-trash-o"></i> Remove venue from list.
								</div>
                              </div>
                </div>
                    ...
                    <!-- tab box top -->
						<div class="col-md-12 green diarypadding">
                            <ul class="row nav nav-tabs">
                              <li class="active"><a class = "topradius noleftborder" href="#tab_a" data-toggle="tab"><h4 class ="midd">Venues</h4></a></li>
                              <li><a class="topradius" href="#tab_b" data-toggle="tab"><h4 class ="midd">Favorites</h4></a></li>
                            </ul>
                    <!-- tab box top close-->       
									...
									<style type="text/css">
										...
										<!-- Could possibly have colour coded appointments,  -->
										  <tr><!-- Top row -->
											...
											<th class="tg-031e midd"><h4>Address</h4></th>
											<th class="tg-031e midd"><h4>Contact</h4></th>
											<th class="tg-031e midd"><h4>Actions</h4></th>
										  </tr>
                                          
										  <tr><!-- Content -->
											<td class="tg-031e"><a href="http://www.roundwoodclinic.co.uk/">Roundwood Health Clinic</a></td>
											<td class="tg-031e">110 Dodworth Road, Barnsley, South Yorkshire, S70 6HL</td>
											<td class="tg-031e">01226 282560, mail@roundwoodclinic.co.uk</td>
											<td class="tg-031e">
                                               <abbr title="Add to Favorites"><i class="fa fa-thumbs-o-up"></i></a></abbr>
                                               <abbr title="View Similar"><i class="fa fa-eye"></i></a></abbr>
                                               <abbr title="Remove"><i class="fa fa-trash-o"></i></a></abbr>
                            ...
                            <!-- tab B --><div class="tab-pane" id="tab_b">
									<style type="text/css">
										...
										<!-- Could possibly have colour coded appointments,  -->
										  ...
										  <tr><!-- Content -->
											<td class="tg-031e"><a href="http://www.roundwoodclinic.co.uk/">Best Surgery Ever</a></td>
											<td class="tg-031e">110 Dodworth Road, Barnsley, South Yorkshire, S70 6HL</td>
											<td class="tg-031e">01226 282560, mail@roundwoodclinic.co.uk</td>
											<td class="tg-031e">
                                               <abbr title="View Similar"><i class="fa fa-eye"></i></a></abbr>
                                               <abbr title="Remove from Favorites"><i class="fa fa-trash-o"></i></a></abbr>
                                               <!-- <abbr title="Edit"><i class="fa fa-pencil"></i></a></abbr> -->
                                            </td>
										  </tr>
										</table>
