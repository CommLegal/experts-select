				...
				<div class="form-group">
                	<div class="col-md-4">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="ea_forename" class="form-control" id="ea_forename" value="<?php echo $info[0]['ea_forename'] ?>" required>
                            
                            <label class="control-label">Surname</label>
                            <input type="text" name="ea_surname" class="form-control" id="ea_surname" value="<?php echo $info[0]['ea_surname'] ?>" required>
                            
                            <label class="control-label">Telephone</label>
                            <input type="text" name="ea_telephone" class="form-control" id="ea_telephone" value="<?php echo $info[0]['ea_telephone'] ?>" required>
                            
                            <label class="control-label">Mobile</label>
                            <input type="text" name="ea_mobile" class="form-control" id="ea_mobile" value="<?php echo $info[0]['ea_mobile'] ?>">
                            
                            <label class="control-label">Email</label>
                            <input type="email" name="ea_email" class="form-control" id="ea_email" value="<?php echo $info[0]['ea_email'] ?>" required>
                    ...
                    <div class="col-md-4">
						...
						<label class="control-label">Address</label>
                            <input type="text" name="ea_address1" class="form-control" id="ea_address1" value="<?php echo $info[0]['ea_address1'] ?>" required>
                            
                          <label class="control-label"></label>
                            <input type="text" name="ea_address2" class="form-control" id="ea_address2" value="<?php echo $info[0]['ea_address2'] ?>">
                            
                            <label class="control-label"></label>
                            <input type="text" name="ea_address3" class="form-control" id="ea_address3" value="<?php echo $info[0]['ea_address3'] ?>">
                            
                            <label class="control-label">City</label>
                            <input type="text" name="ea_city" class="form-control" id="ea_city" value="<?php echo $info[0]['ea_city'] ?>" required>
                            
                            <label class="control-label">Postcode</label>
                            <input type="text" name="ea_postcode" class="form-control" id="ea_postcode" value="<?php echo $info[0]['ea_postcode'] ?>" required>
                            
                            <label class="control-label">County</label>
                            <input type="text" name="ea_county" class="form-control" id="ea_county" value="<?php echo $info[0]['ea_county'] ?>" required>
                            
                            <label class="control-label">Country</label>
                            <input type="text" name="ea_country" class="form-control" id="ea_country" value="<?php echo $info[0]['ea_country'] ?>" required>
                        </div>
                    </div>
