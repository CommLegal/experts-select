...
$(document).ready(function(){
	...
	if($('#add #v_address3').length) {
		// add an onBlur event
		$('#add #v_address3').blur(function(){
...
function get_address(address, region) {
	...
	if(address != '') {
		...
		// lookup the address
		geocoder.geocode( {'v_address3':address,'region':region}, function(results, status) {
