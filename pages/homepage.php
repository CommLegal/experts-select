 <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="row carousel-holder hider">
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img class="img-responsive customer-img" src="<?php echo _ROOT ?>/images/index_banner1.png" alt="Register">
                                    </div>
                                    <div class="item">
                                        <img class="img-responsive customer-img" src="<?php echo _ROOT ?>/images/index_banner2.png" alt="Register">
                                    </div>
                                    <div class="item">
                                        <img class="img-responsive customer-img" src="<?php echo _ROOT ?>/images/index_banner3.png" alt="Register">
                                    </div>
                                </div>
            ...
            <div class="row mb25">
                <div class="col-lg-12"  style="margin-top:-30px">
                    <h4 class="page-header">Our Customers</h4>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6">
                    <img class="img-responsive customer-img" src="http://placehold.it/150x125" alt="">
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6">
                    <img class="img-responsive customer-img" src="http://placehold.it/150x125" alt="">
                </div>
