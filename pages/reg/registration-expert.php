...
if($_POST) {
	...
	if(!$login->create_user($_POST['expertSalutation'], $_POST['organisation'], $_POST['email'], $_POST['password'], $_POST['fName'], $_POST['sName'], $_POST['login_type'])){
...
<div class = "row">
        <div class="col-md-12 hider mb25">
        	<img class="maxwid img-responsive customer-img" src="<?php echo _ROOT ?>/images/exp_reg.png" alt="Request a demo">
  		</div>
</div>
            ...
            <form data-toggle="validator" role="form" id="expert-registration" name="expert-registration" method="post">	
				...
				<div class="form-group">
                	...
                	<div class="form-group col-lg-12">
                        ...
                        <select class="form-control" name="expertSalutation">
                	...
                	<div class="form-group col-lg-6">
                        ...
                        <input type="text" name="fName" class="form-control" placeholder="First Name" id="fName" value="" required>
                    </div>
                    
                    <div class="form-group col-lg-6">
                        <label class="control-label">Last Name</label>
                        <input type="text" name="sName" class="form-control" placeholder="Surname" id="sName" value="" required>
                    </div>
                    ...
                    <div class="form-group col-lg-12 mb25">
                    	By clicking on "Register" you agree to our <a href="?displayPage=terms-and-conditions">Terms and Conditions.</a>
                    </div>
            	</div>
                </form> 
                <?php if($login_error) { ?>
          ...
          <?php } else { ?>
          		<div class="col-md-6">
					<h3>Thankyou for registering</h3>
						...
						<p><button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#login">Click here to Sign in</button></p>
				</div>
          <?php } ?>
          <div class="col-md-6">
          	<h3>Benefits of registration</h3>
            <div class="col-lg-12 lh2"><span class="glyphicon glyphicon-check pr10"></span>It's FREE</div>
            <div class="col-lg-12 lh2"><span class="glyphicon glyphicon-check pr10"></span>Upload your CV</div>
            <div class="col-lg-12 lh2"><span class="glyphicon glyphicon-check pr10"></span>Stay on track with appointments using the booking system</div>
            <div class="col-lg-12 lh2"><span class="glyphicon glyphicon-check pr10"></span>Connect with registered MROs</div>
